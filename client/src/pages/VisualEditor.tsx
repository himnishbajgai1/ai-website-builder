...
import { Loader2, Sparkles, Download, Eye, Copy, Trash2, Plus, Move } from "lucide-react";
...
export default function VisualEditor(props: any) {
  ...
  const generateMutation = trpc.ai.generateWebsite.useMutation({
    onSuccess: (design) => {
      // Convert AI-generated design to visual editor format
